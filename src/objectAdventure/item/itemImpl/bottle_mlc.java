...
public class bottle_mlc implements Item, Observable<String> {
    ...
    public class OpenState implements State {
        ...
        public void InspectBottle() {
            System.out.println("""
                                The liquid in the bottle smell rancidand slightly sweet.
                               """);
        }
        ...
        public void DropBottle() {
            ...
            notifyObservers("Bottle dropped");
        }
        ...
        public void UseBottle() {
            ...
            notifyObservers("The bottle is empty");
        }
    ...
    public class DroppedState implements State {
        ...
        @Override
        public void DropBottle() {
            System.out.printf("You've already dropped the bottle. s%\n", description);
        }
    ...
    public class EmptyState implements State {
        ...
        public void InspectBottle() {
            ...
            System.out.printf(" %s The smell seems to have lingered.\n",description);
            System.out.println();
        }
        ...
        public void DropBottle() {
            ...
            System.out.printf("You drop the bottle. %s\n", description);    
            currentState = new DroppedState();
            notifyObservers("Bottle Dropped");
        }
    ...
    public class TakenState implements State {
        ...
        @Override
        public void InspectBottle() {
            System.out.printf("%s Maybe you can smell what's inside.\n", description);
            System.out.println();
        }
